...
type Handler interface {
	...
	// CheckPermission returns true if the user is allowed to access the job, or an error explaining why not.
	CheckPermission(user user.User, p Permission) (bool, error)
}
